...
public class ToParquet
{
    public static Schema getSchema() throws IOException
    {
        ...
        FSDataInputStream s = fs.open(new Path("hdfs:///schema.parquet"));
    ...
    public static void main (String args []) throws Exception
    {
        ...
        MultipleInputs.addInputPath(job,new Path("hdfs:///title.basics.tsv"),
                TextInputFormat.class, ToParquetBasics.class);

        MultipleInputs.addInputPath(job,new Path("hdfs:///title.ratings.tsv"),
        ...
        FileOutputFormat.setOutputPath(job,new Path("hdfs:///Alinea1_Output_Parquet"));
